...
class ShopDetail(models.Model):
    ...
    comment_detail = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="评价详情"
    )
    avg_price = models.CharField(max_length=20, verbose_name="均价")
    shop_cate = models.CharField(max_length=10, verbose_name="店铺所属分类")
    address = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="店铺地址"
    )
    address_detail = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="店铺地址详情"
    )
