...
import { addTyAdminEmailVerifyRecord, queryTyAdminEmailVerifyRecord, removeTyAdminEmailVerifyRecord, updateTyAdminEmailVerifyRecord, queryTyAdminEmailVerifyRecordVerboseName, queryTyAdminEmailVerifyRecordListDisplay, queryTyAdminEmailVerifyRecordDisplayOrder} from './service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryTyAdminEmailVerifyRecordDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryTyAdminEmailVerifyRecordListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryTyAdminEmailVerifyRecord, table_columns, 'TyAdmin邮箱验证码-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, 'TyAdmin邮箱验证码-select')
                    }
                  }}
                  selectedKeys={[]}
                >
